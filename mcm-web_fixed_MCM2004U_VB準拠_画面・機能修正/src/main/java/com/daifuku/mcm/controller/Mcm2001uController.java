...
public class Mcm2001uController {
     ...
     */
    @PostMapping("/sentei")
    public String sentei(@RequestParam(required = false) BigDecimal selectedNonyusakiId,
    ...
    public String linkToMcm1004u(@RequestParam BigDecimal tmKeiyakujikanId,
                                   HttpSession session) {

        // TODO: Mcm1004uDeliveryDtoを構築してセッションにセット
        session.setAttribute("mcm1004u.tmKeiyakujikanId", tmKeiyakujikanId.intValue());
        // TODO: session.setAttribute("mcm1004u.seniMotoKbn", Mcm1004uConstant.SENIMOTO_TENPO)
    ...
    public String linkToMcm1005u(@RequestParam BigDecimal keiyakuId,
                                   HttpSession session) {

        // TODO: Mcm1005uDeliveryDtoを構築してセッションにセット
        session.setAttribute("mcm1005u.keiyakuId", keiyakuId.intValue());
        // TODO: session.setAttribute("mcm1005u.seniMotoKbn", Mcm1005uConstant.SENIMOTO_TENPO)

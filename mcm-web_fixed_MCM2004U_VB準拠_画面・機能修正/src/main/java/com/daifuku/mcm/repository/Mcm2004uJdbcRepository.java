...
public class Mcm2004uJdbcRepository {
    ...
    public boolean findMaintenance(String loginId) {
        var flags=jdbc.queryForList("SELECT MAINTENANCE_FLG FROM MCM.MCM_MO_TANTO WHERE LOGIN_ID=:loginId",new MapSqlParameterSource("loginId",loginId),String.class);

...
@Service public class Mcm3007uService {
 ...
 public void search(Mcm3007uForm f){
  ...
  if(plants.isEmpty()){f.setGrid1Rows(List.of());f.setGrid2Rows(List.of());f.setGrid3Rows(List.of());return;}
 ...
 @Transactional(isolation=org.springframework.transaction.annotation.Isolation.SERIALIZABLE) public void discard(boolean um,Map<String,String> row,String user){

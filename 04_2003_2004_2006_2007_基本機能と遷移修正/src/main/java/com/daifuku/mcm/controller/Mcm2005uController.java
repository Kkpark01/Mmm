...
public class Mcm2005uController extends BaseController {
    ...
    public String index(
        ...
        model.addAttribute("readOnly",
            service.isReadOnly(form.getJotai(), form.getSyouninJotai()) || Boolean.TRUE.equals(session.getAttribute("mcm2005u.parentReadOnly")) || !hasUpdateAuthority());
    ...
    public String save(@ModelAttribute Mcm2005uForm form,
        ...
        if (!hasUpdateAuthority() || Boolean.TRUE.equals(session.getAttribute("mcm2005u.parentReadOnly"))) {
            ra.addFlashAttribute("error", "権限がないため遷移できません。"); return "redirect:/mcm2005u";
        }
    ...
    public String back(HttpSession session) {
        session.setAttribute("mcm2003u.refreshDetails",true);

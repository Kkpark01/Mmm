...
public final class Mcm0021uConstants {
    ...
    /** #257: 検索済みだが利用者が付替え元を選択していない。 */
    public static final String MSG_MOTO_NOT_CHECKED = "付替え元が１件もチェックされていません。";

    /** #259: 検索済みだが利用者が付替え先を選択していない。 */
    public static final String MSG_SAKI_NOT_CHECKED = "付替え先が１件もチェックされていません。";

    /** 機器情報なし */
    public static final String MSG_NO_KIKI_DATA = "機器情報が存在しない為、付け替え元に設定することは出来ません。";
    ...
    /** 付替え元/先が同一 */
    public static final String MSG_SAME_PLANT = "付替え元と付替え先は異なるデータを指定して下さい。";

    /** 移行先未選択 */
    public static final String MSG_IKOSAKI_NOT_SELECTED = "付替え先ブランドが選択されていないデータがあります。";

    /** チェック未選択 */
    public static final String MSG_NO_CHECK = "付替え対象を1件以上チェックしてください。";

    /** セット数不一致 */
    public static final String MSG_SET_MISMATCH = "ブランド”%1$s”に紐付く個体の中で機器構成”%2$s”を形成できない設定があるため、付替えすることができません。\n機器構成”%2$s”の内容を確認してください。";

    /** 契約不整合警告 */
    public static final String MSG_KEIYAKU_WARNING = "付替えを行うと、プラントが複数となる契約が発生します。付替え実行しますか？";

    /** 付替え確認 */
    public static final String MSG_REPLACE_CONFIRM = "付替えしてもよろしいですか？";

    /** 設定後に対象が移動・変更された場合（完了した内容の再送を含む）。 */
    public static final String MSG_TARGET_CHANGED = "付替え対象が変更されています。再検索して付替え元を設定し直してください。";
